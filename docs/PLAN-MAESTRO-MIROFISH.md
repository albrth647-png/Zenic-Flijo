...
| 0.4 | **Bug #4: Secrets hardcodeados** | 🔴 Crítica | `config.py` tiene `SECRET_KEY = "cambiar_esto_en_produccion"`. Generar keys aleatorias con `secrets.token_urlsafe`. | `src/config.py` | Test de que SECRET_KEY no está hardcodeada |
