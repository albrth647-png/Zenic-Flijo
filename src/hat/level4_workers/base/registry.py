...
class WorkerRegistry:
    ...
    def register(self, tool_name: str, action_name: str, worker_instance: Any) -> None:
        """Registra una instancia de worker."""
        self._workers[(tool_name, action_name)] = worker_instance

    def get(self, tool_name: str, action_name: str) -> Any | None:
    ...
    def list_all(self) -> dict[tuple[str, str], Any]:
