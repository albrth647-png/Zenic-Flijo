...
mutants_x__ensure_api_v2_tables__mutmut: MutantDict = {}  # type: ignore


@_mutmut_mutated(mutants_x__ensure_api_v2_tables__mutmut)
...
def x__ensure_api_v2_tables__mutmut_orig(db: Any) -> None:
    """Crea las tablas adicionales necesarias para la API v2."""
    conn = db.get_connection()
    cursor = conn.cursor()
...
def x__ensure_api_v2_tables__mutmut_1(db: Any) -> None:
    """Crea las tablas adicionales necesarias para la API v2."""
    conn = None
    cursor = conn.cursor()
...
def x__ensure_api_v2_tables__mutmut_2(db: Any) -> None:
    """Crea las tablas adicionales necesarias para la API v2."""
    conn = db.get_connection()
    cursor = None
...
def x__ensure_api_v2_tables__mutmut_3(db: Any) -> None:
    """Crea las tablas adicionales necesarias para la API v2."""
    conn = db.get_connection()
    cursor = conn.cursor()

    cursor.executescript(None)
    conn.commit()

mutants_x__ensure_api_v2_tables__mutmut['_mutmut_orig'] = x__ensure_api_v2_tables__mutmut_orig # type: ignore # mutmut generated
mutants_x__ensure_api_v2_tables__mutmut['x__ensure_api_v2_tables__mutmut_1'] = x__ensure_api_v2_tables__mutmut_1 # type: ignore # mutmut generated
mutants_x__ensure_api_v2_tables__mutmut['x__ensure_api_v2_tables__mutmut_2'] = x__ensure_api_v2_tables__mutmut_2 # type: ignore # mutmut generated
mutants_x__ensure_api_v2_tables__mutmut['x__ensure_api_v2_tables__mutmut_3'] = x__ensure_api_v2_tables__mutmut_3 # type: ignore # mutmut generated
