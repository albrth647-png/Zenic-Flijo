...
mutants_x__get_connector__mutmut: MutantDict = {}  # type: ignore


# ── Helper: obtener connector ────────────────────────────────────────────


@_mutmut_mutated(mutants_x__get_connector__mutmut)
...
def x__get_connector__mutmut_orig() -> WhatsAppConnector:
    """Obtiene una instancia de WhatsAppConnector.
...
def x__get_connector__mutmut_1() -> WhatsAppConnector:
    """Obtiene una instancia de WhatsAppConnector.
    ...
    try:
        ...
        raise HTTPException(status_code=None, detail=f"WhatsAppConnector no disponible: {e}")


# ── Helper: obtener connector ────────────────────────────────────────────


def x__get_connector__mutmut_2() -> WhatsAppConnector:
    """Obtiene una instancia de WhatsAppConnector.
...
def x__get_connector__mutmut_3() -> WhatsAppConnector:
    """Obtiene una instancia de WhatsAppConnector.
    ...
    try:
        ...
        raise HTTPException(detail=f"WhatsAppConnector no disponible: {e}")


# ── Helper: obtener connector ────────────────────────────────────────────


def x__get_connector__mutmut_4() -> WhatsAppConnector:
    """Obtiene una instancia de WhatsAppConnector.
...
def x__get_connector__mutmut_5() -> WhatsAppConnector:
    """Obtiene una instancia de WhatsAppConnector.
    ...
    try:
        ...
        raise HTTPException(status_code=504, detail=f"WhatsAppConnector no disponible: {e}")

mutants_x__get_connector__mutmut['_mutmut_orig'] = x__get_connector__mutmut_orig # type: ignore # mutmut generated
mutants_x__get_connector__mutmut['x__get_connector__mutmut_1'] = x__get_connector__mutmut_1 # type: ignore # mutmut generated
mutants_x__get_connector__mutmut['x__get_connector__mutmut_2'] = x__get_connector__mutmut_2 # type: ignore # mutmut generated
mutants_x__get_connector__mutmut['x__get_connector__mutmut_3'] = x__get_connector__mutmut_3 # type: ignore # mutmut generated
mutants_x__get_connector__mutmut['x__get_connector__mutmut_4'] = x__get_connector__mutmut_4 # type: ignore # mutmut generated
mutants_x__get_connector__mutmut['x__get_connector__mutmut_5'] = x__get_connector__mutmut_5 # type: ignore # mutmut generated
