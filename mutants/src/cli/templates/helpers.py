...
mutants_x_to_class_name__mutmut: MutantDict = {}  # type: ignore


@_mutmut_mutated(mutants_x_to_class_name__mutmut)
...
def x_to_class_name__mutmut_orig(name: str) -> str:
    """
    Convierte un nombre snake_case a CamelCase para nombres de clase.
...
def x_to_class_name__mutmut_1(name: str) -> str:
    """
    Convierte un nombre snake_case a CamelCase para nombres de clase.
...
def x_to_class_name__mutmut_2(name: str) -> str:
    """
    Convierte un nombre snake_case a CamelCase para nombres de clase.
    ...
    Retorna:
        Nombre en formato CamelCase (ej: 'MiConector')
    """
    return "XXXX".join(part.capitalize() for part in name.split("_"))


def x_to_class_name__mutmut_3(name: str) -> str:
    """
    Convierte un nombre snake_case a CamelCase para nombres de clase.
    ...
    Retorna:
        Nombre en formato CamelCase (ej: 'MiConector')
    """
    return "".join(part.capitalize() for part in name.split(None))


def x_to_class_name__mutmut_4(name: str) -> str:
    """
    Convierte un nombre snake_case a CamelCase para nombres de clase.
    ...
    Retorna:
        Nombre en formato CamelCase (ej: 'MiConector')
    """
    return "".join(part.capitalize() for part in name.split("XX_XX"))

mutants_x_to_class_name__mutmut['_mutmut_orig'] = x_to_class_name__mutmut_orig # type: ignore # mutmut generated
mutants_x_to_class_name__mutmut['x_to_class_name__mutmut_1'] = x_to_class_name__mutmut_1 # type: ignore # mutmut generated
mutants_x_to_class_name__mutmut['x_to_class_name__mutmut_2'] = x_to_class_name__mutmut_2 # type: ignore # mutmut generated
mutants_x_to_class_name__mutmut['x_to_class_name__mutmut_3'] = x_to_class_name__mutmut_3 # type: ignore # mutmut generated
mutants_x_to_class_name__mutmut['x_to_class_name__mutmut_4'] = x_to_class_name__mutmut_4 # type: ignore # mutmut generated
