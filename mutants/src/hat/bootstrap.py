...
def bootstrap_hat(
    ...
    from src.hat.level3_specialists.comunicaciones import ChatSpecialist, EmailSpecialist, NotificationSpecialist
    from src.hat.level3_specialists.datos_auto import ApiSpecialist, CodeSpecialist, DataSpecialist
    from src.hat.level3_specialists.operaciones import CrmSpecialist, InventorySpecialist, InvoiceSpecialist
